#!/bin/bash
# Run Julia analytical solution for all test cases
...
julia_script="$script_dir/run_julia_analytical.jl"
...
"
    ...
    output_file="$data_dir/results_julia_${name}.csv"
...
echo "============================================================"
echo "ALL JULIA SOLUTIONS COMPLETE"
